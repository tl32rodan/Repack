"""RepackEngine - main orchestrator for the repack pipeline.
...
class RepackEngine:
    """Orchestrates the full repack pipeline with false-negative prevention."""
    ...
    def run(self) -> bool:
        ...
        """
        logger.info("=" * 60)
        logger.info("Repack Engine starting: %s", self.config.library_name)
        logger.info("=" * 60)
