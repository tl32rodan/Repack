"""Main GUI application window for Repack.
...
from repack.gui.dag_view import DAGViewWidget
from repack.gui.filter_bar import FilterBarWidget
from repack.gui.log_viewer import LogViewerWidget
from repack.gui.summary_table import SummaryTableWidget


class RepackMainWindow(QMainWindow):
    """Main window for Repack GUI."""
    ...
    def __init__(
        ...
        self.setWindowTitle("Repack Summary")
...
class RepackGUI:
    ...
    def launch(
        ...
        window = RepackMainWindow(targets, dag, pvts, corner_kit_names)
        window.show()
        return app.exec_()
